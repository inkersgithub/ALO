        ...
        <div class="w3-section">
            ...
            <div style="margin-top:12px">
                ...
                if(($value->status)==1){
                    ...
                    <p style="float:right;margin-right:25px;font-size: 13px;">New Price - '.$value->book_newprice.'</p><br/><br/>
                    ...
                    echo '<p style="text-align:center;font-size: 13px;">Old Price - '.$value->book_newprice.'</p>';
                }
                ?>
            </div>
            <div>
